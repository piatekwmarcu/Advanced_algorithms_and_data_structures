...
- `02_task_allocation_in_multi-processor_system/`
  - `task_allocation.py` – Python implementation of a task allocation problem for multiple processors with different speeds
  - `output.txt` – example run output/results generated by the program
